...
const DDCB_SET: [Instruction; 256] = instr_set![
    {0x00, 4, 12}, {0x01, 4, 12}, {0x02, 4, 12}, {0x03, 4, 12}, {0x04, 4, 12}, {0x05, 4, 12}, {0x06, 4, 23}, {0x07, 4, 12},
    {0x08, 4, 12}, {0x09, 4, 12}, {0x0a, 4, 12}, {0x0b, 4, 12}, {0x0c, 4, 12}, {0x0d, 4, 12}, {0x0e, 4, 23}, {0x0f, 4, 12},
    {0x10, 4, 12}, {0x11, 4, 12}, {0x12, 4, 12}, {0x13, 4, 12}, {0x14, 4, 12}, {0x15, 4, 12}, {0x16, 4, 23}, {0x17, 4, 12},
    {0x18, 4, 12}, {0x19, 4, 12}, {0x1a, 4, 12}, {0x1b, 4, 12}, {0x1c, 4, 12}, {0x1d, 4, 12}, {0x1e, 4, 23}, {0x1f, 4, 12},
    {0x20, 4, 12}, {0x21, 4, 12}, {0x22, 4, 12}, {0x23, 4, 12}, {0x24, 4, 12}, {0x25, 4, 12}, {0x26, 4, 23}, {0x27, 4, 12},
    {0x28, 4, 12}, {0x29, 4, 12}, {0x2a, 4, 12}, {0x2b, 4, 12}, {0x2c, 4, 12}, {0x2d, 4, 12}, {0x2e, 4, 23}, {0x2f, 4, 12},
    {0x30, 4, 12}, {0x31, 4, 12}, {0x32, 4, 12}, {0x33, 4, 12}, {0x34, 4, 12}, {0x35, 4, 12}, {0x36, 4, 23}, {0x37, 4, 12},
    {0x38, 4, 12}, {0x39, 4, 12}, {0x3a, 4, 12}, {0x3b, 4, 12}, {0x3c, 4, 12}, {0x3d, 4, 12}, {0x3e, 4, 23}, {0x3f, 4, 12},
    {0x40, 4, 12}, {0x41, 4, 12}, {0x42, 4, 12}, {0x43, 4, 12}, {0x44, 4, 12}, {0x45, 4, 12}, {0x46, 4, 20}, {0x47, 4, 12},
    {0x48, 4, 12}, {0x49, 4, 12}, {0x4a, 4, 12}, {0x4b, 4, 12}, {0x4c, 4, 12}, {0x4d, 4, 12}, {0x4e, 4, 20}, {0x4f, 4, 12},
    {0x50, 4, 12}, {0x51, 4, 12}, {0x52, 4, 12}, {0x53, 4, 12}, {0x54, 4, 12}, {0x55, 4, 12}, {0x56, 4, 20}, {0x57, 4, 12},
    {0x58, 4, 12}, {0x59, 4, 12}, {0x5a, 4, 12}, {0x5b, 4, 12}, {0x5c, 4, 12}, {0x5d, 4, 12}, {0x5e, 4, 20}, {0x5f, 4, 12},
    {0x60, 4, 12}, {0x61, 4, 12}, {0x62, 4, 12}, {0x63, 4, 12}, {0x64, 4, 12}, {0x65, 4, 12}, {0x66, 4, 20}, {0x67, 4, 12},
    {0x68, 4, 12}, {0x69, 4, 12}, {0x6a, 4, 12}, {0x6b, 4, 12}, {0x6c, 4, 12}, {0x6d, 4, 12}, {0x6e, 4, 20}, {0x6f, 4, 12},
    {0x70, 4, 12}, {0x71, 4, 12}, {0x72, 4, 12}, {0x73, 4, 12}, {0x74, 4, 12}, {0x75, 4, 12}, {0x76, 4, 20}, {0x77, 4, 12},
    {0x78, 4, 12}, {0x79, 4, 12}, {0x7a, 4, 12}, {0x7b, 4, 12}, {0x7c, 4, 12}, {0x7d, 4, 12}, {0x7e, 4, 20}, {0x7f, 4, 12},
    {0x80, 4, 12}, {0x81, 4, 12}, {0x82, 4, 12}, {0x83, 4, 12}, {0x84, 4, 12}, {0x85, 4, 12}, {0x86, 4, 23}, {0x87, 4, 12},
    {0x88, 4, 12}, {0x89, 4, 12}, {0x8a, 4, 12}, {0x8b, 4, 12}, {0x8c, 4, 12}, {0x8d, 4, 12}, {0x8e, 4, 23}, {0x8f, 4, 12},
    {0x90, 4, 12}, {0x91, 4, 12}, {0x92, 4, 12}, {0x93, 4, 12}, {0x94, 4, 12}, {0x95, 4, 12}, {0x96, 4, 23}, {0x97, 4, 12},
    {0x98, 4, 12}, {0x99, 4, 12}, {0x9a, 4, 12}, {0x9b, 4, 12}, {0x9c, 4, 12}, {0x9d, 4, 12}, {0x9e, 4, 23}, {0x9f, 4, 12},
    {0xa0, 4, 12}, {0xa1, 4, 12}, {0xa2, 4, 12}, {0xa3, 4, 12}, {0xa4, 4, 12}, {0xa5, 4, 12}, {0xa6, 4, 23}, {0xa7, 4, 12},
    {0xa8, 4, 12}, {0xa9, 4, 12}, {0xaa, 4, 12}, {0xab, 4, 12}, {0xac, 4, 12}, {0xad, 4, 12}, {0xae, 4, 23}, {0xaf, 4, 12},
    {0xb0, 4, 12}, {0xb1, 4, 12}, {0xb2, 4, 12}, {0xb3, 4, 12}, {0xb4, 4, 12}, {0xb5, 4, 12}, {0xb6, 4, 23}, {0xb7, 4, 12},
    {0xb8, 4, 12}, {0xb9, 4, 12}, {0xba, 4, 12}, {0xbb, 4, 12}, {0xbc, 4, 12}, {0xbd, 4, 12}, {0xbe, 4, 23}, {0xbf, 4, 12},
    {0xc0, 4, 12}, {0xc1, 4, 12}, {0xc2, 4, 12}, {0xc3, 4, 12}, {0xc4, 4, 12}, {0xc5, 4, 12}, {0xc6, 4, 23}, {0xc7, 4, 12},
    {0xc8, 4, 12}, {0xc9, 4, 12}, {0xca, 4, 12}, {0xcb, 4, 12}, {0xcc, 4, 12}, {0xcd, 4, 12}, {0xce, 4, 23}, {0xcf, 4, 12},
    {0xd0, 4, 12}, {0xd1, 4, 12}, {0xd2, 4, 12}, {0xd3, 4, 12}, {0xd4, 4, 12}, {0xd5, 4, 12}, {0xd6, 4, 23}, {0xd7, 4, 12},
    {0xd8, 4, 12}, {0xd9, 4, 12}, {0xda, 4, 12}, {0xdb, 4, 12}, {0xdc, 4, 12}, {0xdd, 4, 12}, {0xde, 4, 23}, {0xdf, 4, 12},
    {0xe0, 4, 12}, {0xe1, 4, 12}, {0xe2, 4, 12}, {0xe3, 4, 12}, {0xe4, 4, 12}, {0xe5, 4, 12}, {0xe6, 4, 23}, {0xe7, 4, 12},
    {0xe8, 4, 12}, {0xe9, 4, 12}, {0xea, 4, 12}, {0xeb, 4, 12}, {0xec, 4, 12}, {0xed, 4, 12}, {0xee, 4, 23}, {0xef, 4, 12},
    {0xf0, 4, 12}, {0xf1, 4, 12}, {0xf2, 4, 12}, {0xf3, 4, 12}, {0xf4, 4, 12}, {0xf5, 4, 12}, {0xf6, 4, 23}, {0xf7, 4, 12},
    {0xf8, 4, 12}, {0xf9, 4, 12}, {0xfa, 4, 12}, {0xfb, 4, 12}, {0xfc, 4, 12}, {0xfd, 4, 12}, {0xfe, 4, 23}, {0xff, 4, 12},
];
...
impl Cpu {
	...
	let s = match s {
		...
		match pfx {
			...
			if opcode == 0x74 || opcode == 0x75 {
			    self.h //special ld (ix+n), h/l case
			} else {
			    (self.ix >> 8) as u8
			}
		    },
	...
	//adjust wz for ix/iy+n operations (annoying and stupid)
	if pfx == 0xdd || pfx == 0xfd {
	    let x = opcode >> 6;
	    let y = (opcode >> 3) & 7;
	    let z = opcode & 7; //doing it octal-wise is much cleaner

	    match x {
		0 => match opcode {
		    0x34 | 0x35 | 0x36 => self.wz = hlptr,
		    _ => {},
		},
		1 => if opcode != 0x76 {
		    if y == 6 {
			self.wz = hlptr;
		    } else if z == 6 || opcode == 0x77 {
			self.wz = hlptr;
		    }
		},
		2 => if z == 6 {
	...
	match pfx {
		...
		0x40..=0x7f => { //LD r1, r2
		    if (pfx == 0xdd || pfx == 0xfd) && (opcode == 0x66 || opcode == 0x6e) {
			self.movb(0x00, d_bits, s, hlptr); //hack to handle ld h, (ix+n) case
		    } else {
		...
		0x0e | 0x1e | 0x2e | 0x3e => { //LD r, n
		    let op2 = ((opw & 0xff00) >> 8) as u8;
		    if (pfx == 0xdd || pfx == 0xfd) && opcode == 0x36 {
			self.movb(pfx, d_bits, op2, hlptr); //extra displacement byte in ix/iy versions
		    } else {
		...
		0x02 | 0x12 => { //LD (rp), A
		    ...
		    self.wz = ((self.a as u16) << 8) | ((tmp.wrapping_add(1)) & 0xff);
		},
		0x0a | 0x1a => { //LD A, (rp)
		    let tmp = self.read_rp(pfx, rp);
		...
		0x32 => { //LD (nn), A
		    ...
		    self.wz = ((self.a as u16) << 8) | ((opw.wrapping_add(1)) & 0xff);
		},
		0x3a => { //LD A, (nn)
		...
		0x09 | 0x19 | 0x29 | 0x39 => { //ADD HL, rp
		    ...
		    self.wz = (hltmp as u16).wrapping_add(1);
		},
		...
		0x37 => { //SCF
			...
			self.f.set(PSW::X, (self.a & 0x08) != 0 || self.f.contains(PSW::X));
			self.f.set(PSW::Y, (self.a & 0x20) != 0 || self.f.contains(PSW::Y));
		    }
		},
		0x0f => { //RRCA
		...
		0xd3 => { //OUT (n), A
		    ...
		    self.wz = ((self.a as u16) << 8) | (op1 as u16).wrapping_add(1) & 0xff;
		},
		0xdb => { //IN A, (n)
		    self.wz = ((self.a as u16) << 8) + (op1 as u16) + 1;
		...
		0x10 => { //DJNZ
		    let addr = self.pc.wrapping_add_signed((op1 as i8) as i16);
		...
		0x48 | 0x58 | 0x68 | 0x78 => { //16 bit IN
		    ...
		    self.f.remove(PSW::H);
		    self.f.set(PSW::X, (tmp & 0x08) != 0);
		    self.f.set(PSW::P, (tmp.count_ones() % 2) == 0);
		    self.f.remove(PSW::N);
		    self.wz = bctmp.wrapping_add(1);
		},
		0x41 | 0x51 | 0x61 | 0x71 |
		...
		0xa1 | 0xb1 | 0xa9 | 0xb9 => { //CPI/CPD/CPIR/CPDR
		    let tmp1 = self.bus.read_byte(hlptr);
		    let tmp = self.a.wrapping_sub(tmp1);
		    let bc = self.read_rp(pfx, 0);
		    self.write_rp(pfx, 0, bc.wrapping_sub(1));
		    let hl = self.read_rp(pfx, 2);
		    ...
		    self.f.set(PSW::Z, tmp == 0);
		    self.f.set(PSW::H, ((self.a & 0x0f) as i8) - ((tmp & 0x0f) as i8) < 0);
		    let n = self.a.wrapping_sub(tmp1).wrapping_sub(self.f.contains(PSW::H) as u8);
		...
		0xa2 => { //INI
		    ...
		    let tmp = self.bus.read_io_byte(bc);
		    self.bus.write_byte(hlptr, tmp);
		    let btmp = self.b.wrapping_sub(1);
		    let hl = self.read_rp(pfx, 2);
		    let hl = hl.wrapping_add(1);
		    self.write_rp(pfx, 2, hl);

		    let k = self.c.wrapping_add(1) as u16 + tmp as u16;

		    self.f.set(PSW::N, (tmp & 0x80) != 0);
		    self.f.set(PSW::Z, btmp == 0);
		    self.f.set(PSW::S, (btmp & 0x80) != 0);
		    self.f.set(PSW::H, k > 0xff);
		    self.f.set(PSW::C, k > 0xff);
		    let k = ((k as u8) & 7) ^ (btmp);
		    self.f.set(PSW::P, (k.count_ones() % 2) == 0);
		...
		0xaa => { //IND
		    ...
		    let k = self.c.wrapping_sub(1) as u16 + tmp as u16;
		...
		0xa3 => { //OUTI
		    ...
		    self.f.set(PSW::Y, (btmp & 0x20) != 0);
		    self.b = btmp;
		    self.wz = self.read_rp(pfx, 0).wrapping_add(1);
		},
		0xab => { //OUTD
		    let bc = self.read_rp(pfx, 0);
		    let hl = self.read_rp(pfx, 2);
	...
	//adjust q
	match pfx {
	    0x00 | 0xdd | 0xfd => match opcode { //q set when flags modified
		0x00..=0x3f => {
		    match opcode & 0x0f {
			0x4 | 0x5 | 0x7 | 0x9 | 0xc | 0xd | 0xf =>
			    self.q = self.f.as_u8(),
			_ => self.q = 0,
		    }
		},
		0x40..=0x7f => self.q = 0,
		0x80..=0xbf => self.q = self.f.as_u8(),
		0xf1 => self.q = 0,
		_ => {
		    match opcode & 0x0f {
			0x6 | 0xe => self.q = self.f.as_u8(),
			_ => self.q = 0,
		    }
		},
	    },
